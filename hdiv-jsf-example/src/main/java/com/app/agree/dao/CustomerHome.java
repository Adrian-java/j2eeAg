...
import com.app.agree.domain.Customer;
import com.app.agree.service.session.HibernateSession;
import com.app.agree.service.session.MySessionFactory;


/**
 * Home object for domain model class Customer.
 * 
 * @see com.app.agree.domain.Customer
...
public class CustomerHome {
	...
	private final HibernateSession sessionFactory;

	public CustomerHome() {
		sessionFactory = new HibernateSession();
	...
	public void attachDirty(Customer instance) {
		...
		try {
			sessionFactory.getSession().saveOrUpdate(instance);
	...
	public Customer merge(Customer detachedInstance) {
		...
		try {
			Customer result = (Customer) sessionFactory.getSession().merge(
					detachedInstance);
	...
	public Customer findById(java.lang.Integer id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getSession().get(
					"com.xmlxsd.my.domain.Customer", id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = sessionFactory.getSession()
					.createCriteria("com.xmlxsd.my.domain.Customer")
	...
	public List getAll() {
		...
		try {
			List results = sessionFactory.getSession()
					.createCriteria("com.xmlxsd.my.domain.Customer").list();
			log.debug("find by example successful, result size: "
					+ results.size());
			return results;
		} catch (RuntimeException re) {
